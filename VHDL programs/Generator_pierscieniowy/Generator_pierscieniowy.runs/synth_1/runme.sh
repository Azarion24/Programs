...
HD_PWD='C:/Users/mateu/Desktop/PUL_Projects/Generator_pierscieniowy/Generator_pierscieniowy.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UKLAD.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UKLAD.tcl
