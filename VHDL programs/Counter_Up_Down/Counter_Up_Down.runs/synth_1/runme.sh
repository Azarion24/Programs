...
HD_PWD='C:/Users/mateu/Desktop/PUL_Projects/Counter_Up_Down/Counter_Up_Down.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Counter_Up_Down.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Counter_Up_Down.tcl
