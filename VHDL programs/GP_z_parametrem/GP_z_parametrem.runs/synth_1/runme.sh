...
HD_PWD='C:/Users/mateu/Desktop/PUL_Projects/GP_z_parametrem/GP_z_parametrem.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RINGOSCN.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RINGOSCN.tcl
