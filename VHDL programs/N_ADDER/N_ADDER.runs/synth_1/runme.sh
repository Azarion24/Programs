...
HD_PWD='C:/Users/mateu/Desktop/PUL_Projects/N_ADDER/N_ADDER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SUMNB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SUMNB.tcl
