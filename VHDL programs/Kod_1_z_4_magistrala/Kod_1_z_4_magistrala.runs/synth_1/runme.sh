...
HD_PWD='C:/Users/mateu/Desktop/PUL_Projects/Kod_1_z_4_magistrala/Kod_1_z_4_magistrala.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Kod_1_z_4_magistrala.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Kod_1_z_4_magistrala.tcl
