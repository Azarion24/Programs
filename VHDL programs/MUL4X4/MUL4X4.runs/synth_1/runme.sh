...
HD_PWD='C:/Users/mateu/Desktop/PUL_Projects/MUL4X4/MUL4X4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MUL4X4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MUL4X4.tcl
